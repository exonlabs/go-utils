...
func TestCopyFile(t *testing.T) {
	...
	assert.NoError(t, err, "should not return error on writing to source file")

	err = fsx.Copy(srcFile, dstFile)
	assert.NoError(t, err, "should not return error during file copy")

	content, err := os.ReadFile(dstFile)
	assert.NoError(t, err, "should not return error reading the destination file")
...
func TestCopySymlink(t *testing.T) {
	...
	assert.NoError(t, err, "should not return error reading destination symlink")
